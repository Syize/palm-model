...
!--             If surface fractions is given, also check that only one type is given.
                ...
                THEN
                   WRITE( message_string, * ) 'surface_fraction is given for more than one type ', &
                                              'at location (i,j) = (', i, ',', j, ')'
...
!--             vegetation, pavement or water is defined.
                ...
                THEN
                   ...
                   THEN
                      WRITE( message_string, * ) 'sum of all land-surface fractions does not ',     &
...
!--             Relative fraction for a type must not be zero at locations where this type is set.
                ...
                THEN
                   WRITE( message_string, * ) 'mismatch in setting of surface_fraction at ',       &
                                              'location (i,j) = (', i, ',', j, ')'
...
!--          pavement_subsurface_pars must be set at this location.
             IF ( pavement_type_f%from_file )  THEN
                IF ( pavement_type_f%var(j,i) == 0 )  THEN
                   ...
                   THEN
                      WRITE( message_string, * ) 'pavement_subsurface_pars missing at location ',  &
                                                 '(i,j) = (', i, ',', j, ')'
