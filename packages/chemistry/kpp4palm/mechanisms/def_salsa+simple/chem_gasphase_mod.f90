...
! End INLINED RCONST
  ...
  rconst(1) = (phot(j_no2))
  rconst(2) = (2.0_wp * 2.2e-10_wp * phot(j_o31d) / (arr2(1.9e+8_wp , -390.0_wp , temp)))
  rconst(3) = (arr2(1.80e-12_wp , 1370.0_wp , temp))
  rconst(4) = (arr2(2.00e-11_wp , 500.0_wp , temp))
  rconst(5) = (arr2(4.20e-12_wp , -180.0_wp , temp))
  rconst(6) = (arr2(3.70e-12_wp , -240.0_wp , temp))
  rconst(7) = (arr2(1.15e-11_wp , 0.0_wp , temp))
  rconst(8) = (1.0_wp)
  rconst(9) = (1.0_wp)
  rconst(10) = (1.0_wp)
  rconst(11) = (1.0_wp)
